...
async function find() {
  ...
  if (findPokemon.value) {
    ...
    res.data.types.forEach((element) => {
      switch (element.type.name) {
        case "fire":
          types2.value.push("../img/Fire.png");
          break;
        case "water":
          types2.value.push("../img/Water.png");
          break;
        case "grass":
          types2.value.push("../img/Grass.png");
          break;
        case "electric":
          types2.value.push("../img/Electric.png");
          break;
        case "ice":
          types2.value.push("../img/Ice.png");
          break;
        case "fighting":
          types2.value.push("../img/Fighting.png");
          break;
        case "poison":
          types2.value.push("../img/Poison.png");
          break;
        case "ground":
          types2.value.push("../img/Ground.png");
          break;
        case "flying":
          types2.value.push("../img/Flying.png");
          break;
        case "psychic":
          types2.value.push(".../img/Psychic.png");
          break;
        case "bug":
          types2.value.push("../img/Bug.png");
          break;
        case "rock":
          types2.value.push("../img/Rock.png");
          break;
        case "ghost":
          types2.value.push("../img/Ghost.png");
          break;
        case "dragon":
          types2.value.push("../img/Dragon.png");
          break;
        case "dark":
          types2.value.push("../img/Dark.png");
          break;
        case "steel":
          types2.value.push("../img/Steel.png");
          break;
        case "fairy":
          types2.value.push("../img/Fairy.png");
          break;
        case "normal":
          types2.value.push("../img/Normal.png");
          break;
        default:
          break;
      }
...
function getIcon(statName) {
  ...
  return icons[statName] || 'las la-question'; 
}
